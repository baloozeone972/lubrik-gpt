...
Application de compagnon virtuel développée en Java 21 avec Spring Boot, offrant des interactions personnalisées avec des personnages IA. Cette documentation couvre l'installation, la configuration et le déploiement local pour les tests.
